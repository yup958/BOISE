...
i <- as.numeric(value)
holdsub = c(6,10,12,17,21,24,31,35,36,55,60,61,63:66,72:74,82,92,93,96,103,109,111,113:115,117,119,122,
            128,132,138,144,145,147,148,152,163,166,168,170,171,176,177,179,180,183,184,186:189,191,
            192,194,195,197,199,202,207,209,211,218,221,223,235,240,241,246,247, 249,253,255,258,262,264,
            266,267,271,272,274,276,278:280,282,284:289,291:294,296:298,301,303,306:312,314,318,319,325,
            327:329,333:335,337:366)
A = holdsub[i+1]
nA = 1
nT = 10
pel_value = pel1(A, nA, nT, cl, dat)
value = as.character(A-1)
if(nchar(value) == 1){
